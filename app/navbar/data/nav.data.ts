...
export const NAV_ITEMS: NavItem[] = [
  { id: "talleres",   lines: ["Talleres",       "& Cursos"],          iconName: "Hand",     iconColor: "#1DAB8E" },
  { id: "cafes",      lines: ["Arte &",          "Pinturas"],         iconName: "Coffee",   iconColor: "#1DAB8E" },
  { id: "fiestas",    lines: ["Eventos",     ""],        iconName: "Sparkles", iconColor: "#1DAB8E" },
  { id: "sedes",      lines: ["Nuestra",       "sede"],             iconName: "MapPin",   iconColor: "#D4820A" },
  { id: "membresias", lines: ["Precios",     ""],        iconName: "Crown",    iconColor: "#D4820A" },
];
...
export const TALLERES_CATEGORIES: MegaCategoryCard[] = [
  ...
  },
  {
    title: "CERÁMICA",
    bg: "#C4B5F4",
    tags: ["Pintura cerámica","Cursos de cerámica","Curso de alfarería","Torno de alfarería","Estudio abierto PIE"],
  },
  {
    title: "MANUALIDADES",
    bg: "#daf4d8",
  ...
  },
  {
    title: "PIE NIÑOS",
    bg: "#FFD6E0",
    tags: ["Extraescolar","Cursos de vacaciones","Arte en pijamas"],
  },
];
...
export const CAFES_LOCATIONS: MegaCategoryCard[] = [
  {
    title: "CAFÉ CREATIVO\nBUENOS AIRES",
    bg: "#A8F0D0",
    tags: ["Pintura cerámica","Comida & bebidas","Fiestas pequeñas","Eventos comunitarios BA","Reservar mesa"],
  },
  {
...
export const SEDES_LOCATIONS = [
  {
    ...
    tags: ["Café Creativo BA","Estudio de Pintura BA","Estudio de Cerámica BA","Estudio Infantil BA"],
    btn: "Explorar PIE Buenos Aires",
    bg: "linear-gradient(160deg,#2a2a2a,#3a3030)",
  },
  {
    title: "PIE CÓRDOBA",
    tags: ["Estudio Cerámica Córdoba","Estudio Pintura Córdoba","Estudio Cerámica Córdoba"],
...
export const MEMBRESIAS_CARDS = [
  ...
  { title: "MEMBRESÍAS",      bg: "#C4D4F0", emoji: "💳", btn: "Descubrir membresías" },
  { title: "CAJAS DE REGALO", bg: "#FFD6E0", emoji: "🎨", btn: "Comprar caja de regalo" },
];
